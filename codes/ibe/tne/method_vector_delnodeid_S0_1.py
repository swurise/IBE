...
if __name__ == "__main__":
    for mydata in datasets:  # 遍历数据集 modify by huganglin 20200131
        for mymethod in methods:  # 遍历数据集 modify by huganglin 20200131
            ...
            train_all_sort_noid = basepath + '/' + mydata + '/method_vector/' + mymethod + '_train_sort_noid.txt'
            print(train_all_sort, ', ', train_all_sort_noid)
            sorted_noid = Read_list_noid(train_all_sort)
            Save_list(sorted_noid, train_all_sort_noid)