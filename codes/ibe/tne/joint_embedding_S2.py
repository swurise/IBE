...
if __name__ == "__main__":
    for mydata in datasets:  # 遍历数据集 modify by huganglin 20200131
        for mymethod in methods:
            ...
            # jointvector_path = basepath + '/' + mydata + '/' + str(psi_coefficient) + '_joint_vector/' + mymethod + '_' + t + '_joint.txt'
            # psi = psi_coefficient
            jointvector_path = basepath + '/' + mydata + '/psi_dict_joint_vector/' + mymethod + '_' + t + '_joint.txt'
